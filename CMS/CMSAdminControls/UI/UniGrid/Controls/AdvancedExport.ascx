                        ...
                        <asp:PlaceHolder ID="plcAdvancedExport" runat="server">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="editing-form-value-cell">
                                        <cms:CMSCheckBox ID="chkCurrentPageOnly" runat="server" Checked="true" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="editing-form-label-cell">
                                    ...
                                    <div class="form-group">
                                        <div class="editing-form-label-cell">
                                            <cms:LocalizedLabel ID="lblUseGridFilter" runat="server" ResourceString="export.usegridfilter"
                                                DisplayColon="true" EnableViewState="false" CssClass="control-label" AssociatedControlID="chkUseGridFilter" />
                                        </div>
                                        <div class="editing-form-value-cell">
                                            <cms:CMSCheckBox ID="chkUseGridFilter" runat="server" Checked="true" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="editing-form-label-cell">
