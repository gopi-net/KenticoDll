...
!function (a) {
    if (!a.browser) {
        var b = {}, c = navigator.userAgent.toLowerCase(), d = /(chrome)[ \/]([\w.]+)/.exec(c) || /(webkit)[ \/]([\w.]+)/.exec(c) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(c) || /(msie) ([\w.]+)/.exec(c) || c.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(c) || [], e = {browser: d[1] || "", version: d[2] || 0};
        e.browser && (b[e.browser] = !0, b.version = e.version), b.chrome ? b.webkit = !0 : b.webkit && (b.safari = !0), a.browser = b
    }
}(jQuery), function (a, b, c) {
    var d = {getEvent: function (a) {
        return a || b.event
        ...
        if (1 === b.which) {
            var d, g, h, i, j, k, l, m, n, o = b.data.pane, p = a(o).data("enscroll"), q = !0, r = function () {
                ...
                return q && (h = a.clientY - k - j, h = Math.min(0 > h ? 0 : h, m)), !1
            }, t = function () {
                return q = !1, c.body.style.cursor = l, this.style.cursor = "", d.removeClass("dragging"), a(c.body).off("mousemove.enscroll.vertical").off("mouseup.enscroll.vertical"), a(c).off("mouseout.enscroll.vertical"), !1
            };
            return d = a(p.verticalTrackWrapper).find(".enscroll-track"), g = d.children().first()[0], h = parseInt(g.style.top, 10), n = o.scrollHeight - a(o).innerHeight(), j = b.clientY - a(g).offset().top, m = d.height() - a(g).outerHeight(), k = d.offset().top, a(c.body).on({"mousemove.enscroll.vertical": s, "mouseup.enscroll.vertical": function (a) {
                t.call(g, a)
            }}), a(c).on("mouseout.enscroll.vertical", function (a) {
                a.target.nodeName && "HTML" === a.target.nodeName.toUpperCase() && t.call(g, a)
            }), d.hasClass("dragging") || (d.addClass("dragging"), l = a(c.body).css("cursor"), this.style.cursor = c.body.style.cursor = "ns-resize"), r(), !1
        }
    }, j = function (b) {
        if (1 === b.which) {
            var d, g, h, i, j, k, l, m, n, o = b.data.pane, p = a(o).data("enscroll"), q = !0, r = function () {
                ...
                return q && (h = a.clientX - l - k, h = Math.min(0 > h ? 0 : h, n), f.call(o)), !1
            }, t = function () {
                return q = !1, d.removeClass("dragging"), c.body.style.cursor = m, this.style.cursor = "", d.removeClass("dragging"), a(c.body).off("mousemove.enscroll.horizontal").off("mouseup.enscroll.horizontal"), a(c).off("mouseout.enscroll.horizontal"), !1
            };
            return d = a(p.horizontalTrackWrapper).find(".enscroll-track"), g = d.children().first()[0], h = parseInt(g.style.left, 10), j = o.scrollWidth - a(o).innerWidth(), k = b.clientX - a(g).offset().left, n = d.width() - a(g).outerWidth(), l = d.offset().left, a(c.body).on({"mousemove.enscroll.horizontal": s, "mouseup.enscroll.horizontal": function (a) {
                t.call(g, a)
            }}), a(c).on("mouseout.enscroll.horizontal", function (a) {
                a.target.nodeName && "HTML" === a.target.nodeName.toUpperCase() && t.call(g, a)
            }), d.hasClass("dragging") || (d.addClass("dragging"), m = a("body").css("cursor"), this.style.cursor = c.body.style.cursor = "ew-resize"), r(), !1
        }
    }, k = function (a) {
        ...
        var b, c, d, f, i, j, k, l = this, m = function (a) {
            b = a.touches[0].clientX, c = a.touches[0].clientY, d || (d = c === i && b === f ? void 0 : Math.abs(i - c) > Math.abs(f - b) ? "y" : "x"), a.preventDefault()
        }, n = function () {
            j && ("y" === d ? (g(l, i - c), k = i - c, i = c) : "x" === d && (h(l, f - b), k = f - b, f = b), e(n))
        }, o = function () {
            var a = 0, b = Math.round(Math.abs(1.75 * k)), c = 10 * k * Math.log(2);
            this.removeEventListener("touchmove", m, !1), this.removeEventListener("touchend", o, !1), j = !1, e(function f() {
                if (a !== b && !j) {
        ...
        return this.each(function () {
            var b, c = a(this).data("enscroll"), d = this, e = a(d), f = -1, g = -1, h = -1, i = -1, j = function () {
                if (c.settings.pollChanges) {
                    ...
                    (c.settings.verticalScrolling && (m !== g || k !== i) || c.settings.horizontalScrolling && (l !== f || a !== h)) && (h = a, i = k, o.resize.call(e)), (b.left !== n.left || b.top !== n.top || l !== f || m !== g) && (b = n, f = l, g = m, o.reposition.call(e)), setTimeout(j, 350)
                }
            };
    ...
    a.fn.enscroll = function (d) {
        ...
        var e = a.extend({verticalScrolling: !0, horizontalScrolling: !1, showOnHover: !1, scrollIncrement: 20, minScrollbarLength: 40, pollChanges: !0, drawCorner: !0, drawScrollButtons: !1, clickTrackToScroll: !0, verticalTrackClass: "vertical-track", horizontalTrackClass: "horizontal-track", horizontalHandleClass: "horizontal-handle", verticalHandleClass: "vertical-handle", scrollUpButtonClass: "scroll-up-btn", scrollDownButtonClass: "scroll-down-btn", scrollLeftButtonClass: "scroll-left-btn", scrollRightButtonClass: "scroll-right-btn", cornerClass: "scrollbar-corner", zIndex: 1, addPaddingToPane: !0, horizontalHandleHTML: '<div class="left"></div><div class="right"></div>', verticalHandleHTML: '<div class="top"></div><div class="bottom"></div>'}, d);
        return this.each(function () {
            if (e.verticalScrolling || e.horizontalScrolling) {
                var d, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = a(this), G = this, H = F.attr("style"), I = !0, J = {position: "absolute", "z-index": e.zIndex, margin: 0, padding: 0}, K = function (a) {
                    k.call(F, a)
                }, L = function (b, c) {
                    "string" == typeof c ? a(b).html(c) : "object" == typeof c && null !== c && c.nodeType && 1 === c.nodeType && b.appendChild(c)
                };
                if (e.verticalScrolling) {
                    p = c.createElement("div"), r = c.createElement("div"), t = c.createElement("a"), a(r).css("position", "relative").addClass("enscroll-track").addClass(e.verticalTrackClass).appendTo(p), e.drawScrollButtons && (u = c.createElement("a"), v = c.createElement("a"), a(u).css({display: "block", "text-decoration": "none"}).attr("href", "").html("&nbsp;").addClass(e.scrollUpButtonClass).on("click",function () {
                        return g(G, -e.scrollIncrement), !1
                    }).insertBefore(r), a(v).css({display: "block", "text-decoration": "none"}).attr("href", "").html("&nbsp;").on("click",function () {
                        return g(G, e.scrollIncrement), !1
                    ...
                    }), a(t).css({position: "absolute", "z-index": 1}).attr("href", "").addClass(e.verticalHandleClass).mousedown({pane: this}, i).click(function () {
                        return!1
                        ...
                        f.call(G)
                    }), z = a(r).outerWidth(), e.addPaddingToPane && F.css({width: F.width() - z + "px", "padding-right": parseInt(F.css("padding-right"), 10) + z + "px"});
                    try {
                ...
                e.horizontalScrolling && (d = c.createElement("div"), q = c.createElement("div"), s = c.createElement("a"), a(q).css({position: "relative", "z-index": 1}).addClass("enscroll-track").addClass(e.horizontalTrackClass).appendTo(d), e.drawScrollButtons && (w = c.createElement("a"), x = c.createElement("a"), a(w).css("display", "block").attr("href", "").on("click",function () {
                ...
                }), a(s).css({position: "absolute", "z-index": 1}).attr("href", "").addClass(e.horizontalHandleClass).click(function () {
                    return!1
                }).mousedown({pane: this}, j).appendTo(q), L(s, e.horizontalHandleHTML), a(d).css(J).insertAfter(this), e.showOnHover && a(d).css("opacity", 0).on("mouseover.enscroll.horizontal",function () {
                    f.call(G, !1)
                }).on("mouseout.enscroll.horizontal", function () {
                    f.call(G)
                }), y = a(q).outerHeight(), e.addPaddingToPane && F.css({height: F.height() - y + "px", "padding-bottom": parseInt(F.css("padding-bottom"), 10) + y + "px"}), (!a.browser.msie || a.browser.msie && a.browser.version > 7) && (E = document.createElement("div"), a(E).css({width: "1px", height: "1px", visibility: "hidden", padding: 0, margin: "-1px"}).appendTo(this))), e.verticalScrolling && e.horizontalScrolling && e.drawCorner && (A = c.createElement("div"), a(A).addClass(e.cornerClass).css(J).insertAfter(this)), C = F.attr("tabindex"), (!C || C.length < 1) && (F.attr("tabindex", 0), I = !1);
                try {
                    B = F.css("outline"), (!B || B.length < 1) && F.css("outline", "none")
                } catch (M) {
                    F.css("outline", "none")
                }
                F.on({"scroll.enscroll.pane": function (a) {
                    l.call(this, a)
                }, "keydown.enscroll.pane": m}).css("overflow", "hidden").data("enscroll", {settings: e, horizontalTrackWrapper: d, verticalTrackWrapper: p, corner: A, _prybar: E, _mouseScrollHandler: K, _hadTabIndex: I, _style: H}), a(b).on("resize.enscroll.window", function () {
                    o.reposition.call(F)
                }), e.showOnHover && F.on("mouseenter.enscroll.pane", function () {
                    f.call(this)
                }), this.addEventListener ? (this.addEventListener("mousewheel", K, !1), this.addEventListener("DOMMouseScroll", K, !1), this.addEventListener("touchstart", n, !1)) : this.attachEvent && this.attachEvent("onmousewheel", K), e.pollChanges ? o.startPolling.call(F) : (o.resize.call(F), o.reposition.call(F)), a(r, q).removeClass(e.verticalTrackClass).addClass(e.verticalTrackClass)
            }
        })
    }
