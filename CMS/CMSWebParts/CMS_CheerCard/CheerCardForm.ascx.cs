...
public partial class CMSWebParts_CMS_CheerCard_CheerCardForm : CheerCardFormWebPart
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        cmdBackToCheerCardForm.Click += cmdBackToCheerCardForm_Click;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    void cmdBackToCheerCardForm_Click(object sender, EventArgs e)
    {
        cheercardMV.SetActiveView(CheerCardFormView);
    }
