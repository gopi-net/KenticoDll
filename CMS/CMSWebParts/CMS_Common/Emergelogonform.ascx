<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSWebParts_CMS_Common_Emergelogonform"
    CodeFile="~/CMSWebParts/CMS_Common/Emergelogonform.ascx.cs" %>
                                        ...
                                        <table style="border: none; width: 100%; border-collapse: separate;">
                                            ...
                                            <asp:PlaceHolder runat="server" ID="plcLoginInputs">
                                                <tr>
                                                    <td>
                                                        <label>
                                <cms:LocalizedLiteral ID="EmergeLogonUsername" ResourceString="Emerge.LogonForm.Label" runat="server" />
                                                    ...
                                                    <td style="white-space: nowrap;">
                                                       ...
                                                       <cms:CMSRequiredFieldValidator ID="rfvUserNameRequired" CssClass="ErrorMessage" runat="server" ControlToValidate="UserName"
                                                         EnableViewState="false" >
                                                           <label>
                                                               <cms:LocalizedLiteral ID="EmergeLogonErrorMessage" ResourceString="Emerge.LogonForm.Error" runat="server" />
                                                        </label>

                                                       </cms:CMSRequiredFieldValidator></td></tr><tr>
                                                    <td style="white-space: nowrap;">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        ...
                                        <label>
                                <cms:LocalizedLiteral ID="EmergePasswordRetrievelText" ResourceString="Emerge.LogonForm.PasswordRetrievel" runat="server" />
                               </label>
                                         <!-- <asp:Label ID="lblPasswdRetrieval" runat="server" EnableViewState="false" AssociatedControlID="txtPasswordRetrieval" />--></td></tr><tr>
                                    <td>
