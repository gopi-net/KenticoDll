...
<%@ Register TagPrefix="cc1" Namespace="CMS.DocumentEngine.Web.UI" Assembly="CMS.DocumentEngine.Web.UI" %><table>
  <tr>
    <td>Custom Table Class Name:</td>
    <td><%# Eval("CustomTableClassName") %></td>
  </tr>
  <tr>
    <td>State Master Table Class Name:</td>
    <td><%# Eval("MasterTableName") %></td>
  </tr>
  <tr>
    <td>State Name Column:</td>
    <td><%# Eval("MasterTableStateNameColumnName") %></td>
  </tr>
  <tr>
    <td>Created by:</td>
