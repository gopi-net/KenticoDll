...
<h4>
<a href="<%# ForumFunctions.GetPostURL("/Groups/{%CommunityContext.CurrentGroup.GroupName|(user)chandaranik|(hash)b92eed50c10657fc9c05dafa3e2581540848a1e447053c9ab7dfdf4cf28ff472%}/Forums",Eval("PostIDPath"), Eval("PostForumID")) %>"><%# Eval("PostSubject",true) %></a>
</h4>
<div>
