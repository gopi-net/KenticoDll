  ...
  <%-- Search result image --%>
        ...
        <div class="LeftAlign">
            ...
            <div style="text-align: left;">
                <a style="font-weight: bold" href="<%# "javascript:SelectItem(" + CMS.Base.Web.UI.ControlsHelper.RemoveDynamicControls(ValidationHelper.GetString(GetSearchValue("nodeId"), "")) + ", '"+ ValidationHelper.GetString(GetSearchValue("DocumentCulture"), "") + "')" %>">
                    <%#SearchHighlight(CMS.Helpers.HTMLHelper.HTMLEncode(DataHelper.GetNotEmpty(Eval("Title"), "/")), "<span style='font-weight:bold;'>", "</span>")%> (<%#ValidationHelper.GetString(GetSearchValue("DocumentCulture"), "")%>)
                </a>
            </div>
