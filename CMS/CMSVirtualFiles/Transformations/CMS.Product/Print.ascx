...
<div class="name">
  ...
  <div class="floatRight"><cms:QRCode ID="wQR" runat="server" MaxSideSize="70" Tooltip='<%# EvalText("SkuName") %>' AlternateText='<%# EvalText("SkuName") %>' Code='<%# CMS.MacroEngine.MacroContext.CurrentResolver.ResolveMacros("{%SiteDomainName%}{%ApplicationPath%}/Mobile/Product-Detail/" + Eval("NodeAlias") + ".aspx") %>' /></div>
  <div class="clear"></div>
</div>
<div class="left floatLeft">
    <table class="main" cellpadding=0 cellspacing=0>
      ...
      <tr>
        <%# IfEmpty(GetSKUIndicatorProperty("PublicStatusDisplayName"), "", "<td class=\"bold\">Status:</td><td>" + GetSKUIndicatorProperty("PublicStatusDisplayName") + "</td>") %>
      </tr>
      <tr>
      ...
      <% if(GetSKUListPrice() > 0){ %>
      <tr>
        <td class="bold" style="padding-top: 13px;border-top: 1px solid black;">List price:</td>
        <td style="padding-top: 13px;border-top: 1px solid black;"><%# GetSKUFormattedListPrice() %></td>
      </tr>
      <tr>
