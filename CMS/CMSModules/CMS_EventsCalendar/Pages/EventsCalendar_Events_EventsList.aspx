<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventsCalendar_Events_EventsList.aspx.cs" EnableEventValidation="false"
     MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Events - Data List" Theme="Default"
     Inherits="CMSModules_CMS_EventsCalendar_Pages_EventsCalendar_Events_EventsList" %>
