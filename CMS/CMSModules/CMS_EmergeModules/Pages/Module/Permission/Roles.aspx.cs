...
public partial class CMSModules_CMS_EmergeModules_Pages_Module_Permission_Roles : GlobalAdminPage
{
    #region "Constants"
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        if (Permission != null)
        {
            ...
            else
            {
                ...
                {
                    headTitle.Text = GetString("Administration-Permissions_Matrix.GlobalAdministrator");
                }
