...
public partial class CMSModules_CMS_EmergeModules_Pages_Module_UserInterface_Design : CMSUIPage
{
    ...
    protected override void OnPreInit(EventArgs e)
    {
        ...
        if (ui != null)
        {
            ...
            // Store resource name
            UIContext.ResourceName = ApplicationUrlHelper.GetResourceName(ui.ElementResourceID);
