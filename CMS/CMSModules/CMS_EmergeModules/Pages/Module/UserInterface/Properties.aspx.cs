...
public partial class CMSModules_CMS_EmergeModules_Pages_Module_UserInterface_Properties : GlobalAdminPage
{
    #region "Variables"
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        xml.Load(ResolveUrl(HttpContext.Current.Server.MapPath(CMS.PortalEngine.PortalFormHelper.BEFOREPROPERTIESDEFINITION)));
