...
public partial class CMSModules_CMS_EmergeCustomTables_CustomTables_Tools_CustomTable_Data_List : CMSCustomTablesToolsPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((dci != null) && dci.ClassIsCustomTable)
        {
            ...
            // New item link
            bool canCreate = MembershipContext.AuthenticatedUser.IsAuthorizedPerResource("cms.customtables", "Create") || MembershipContext.AuthenticatedUser.IsAuthorizedPerClassName(dci.ClassName, "Create");
