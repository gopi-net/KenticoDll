<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MappingDialogCustomTable.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_Contact_MappingDialogCustomTable" %>
...
<asp:Panel ID="pnlPersonal" runat="server" CssClass="ContentPanel">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="editing-form-value-cell">
                <uc:ClassFields ID="fldBirthday" runat="server" FieldDataType="Text" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
        ...
        <div class="form-group">
            ...
            <div class="editing-form-value-cell">
                <uc:ClassFields ID="fldGender" runat="server" FieldDataType="Text" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
