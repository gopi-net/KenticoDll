...
public partial class CMSModules_CMS_EmergeCommon_FormControls_MultipleChoiceControl : EmergeBaseFormEngineUserControl
{
    #region "Variables"
    ...
    private void LoadAndSelectList()
    {
        if (list.Items.Count == 0)
        {
            ...
            /*Changes Done Added true*/
            //FormHelper.SelectMultipleValues(selectedValues, list.Items,ListSelectionMode.Multiple);
            FormControlsHelper.SelectMultipleValues(selectedValues, list.Items, true);
        }
    }
