...
public partial class CMSModules_CMS_EmergeCommon_FormControls_PasswordStrength : EmergeBaseFormEngineUserControl
{
    #region "Variables"
    ...
    private string SiteName
    {
        get
        {
            if (mSiteName == null)
            {
                mSiteName = EmergeCMSContext.CurrentSiteName;
            }
    ...
    public override object Value
    {
        ...
        set
        {
            ...
            if (QueryHelper.GetInteger("itemid", 0) > 0)
                TextBoxAttributes.Add("value", Constants.HIDDENPASSWORD);
        }
    }
