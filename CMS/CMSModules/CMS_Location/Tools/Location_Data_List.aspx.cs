...
public partial class CMSModules_Location_Tools_Location_Data_List : LocationDataListPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ListPage = LocationConstants.PAGEURL_LIST_LOCATION;
            SelectFieldsPage = LocationConstants.PAGEURL_DATA_SELECTFIELDS;

            customTableDataList.EditItemPage = LocationConstants.PAGEURL_DATA_EDITITEM;
            customTableDataList.ViewItemPage = LocationConstants.PAGEURL_DATA_VIEWITEM; 
            ...
            if (DataClassInfo != null)
            {
                ...
                customTableDataList.GridName = "~/CMSModules/CMS_Location/Tools/Location_Data_List.xml";
