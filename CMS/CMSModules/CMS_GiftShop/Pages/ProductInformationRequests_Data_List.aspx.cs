...
public partial class CMSModules_GiftShop_Pages_ProductInformationRequests_Data_List : GiftShopDataListPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ListPage = GiftShopConstants.PAGEURL_DATA_LIST;
            ...
            if (DataClassInfo != null)
            {
                ...
                customTableDataList.GridName = "~/CMSModules/CMS_GiftShop/Pages/ProductInformationRequests_Data_List.xml";
