<%@ Page Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_GiftShop_Pages_ProductInformationRequests_Data_List" EnableEventValidation="false"
    MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Gift Shop - Data List"
    Theme="Default" CodeFile="ProductInformationRequests_Data_List.aspx.cs" %>
