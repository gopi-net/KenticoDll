<%@ Page Language="C#" AutoEventWireup="true" Inherits="CMSModules_CMS_EmergePortalEngine_UI_WebParts_WebPartProperties_buttons"
...
<asp:Content ID="pnlContent" ContentPlaceHolderID="plcContent" runat="server">
    <asp:Panel runat="server" ID="pnlContent" CssClass="dialog-footer">
        ...
        <div class="FloatRight">
            ...
            <cms:CMSButton ID="btnApply" runat="server" ButtonStyle="Primary" />
        </div>
    </asp:Panel>
