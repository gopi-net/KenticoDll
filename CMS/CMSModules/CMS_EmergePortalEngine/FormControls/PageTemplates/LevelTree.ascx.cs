...
public partial class CMSModules_CMS_EmergePortalEngine_FormControls_PageTemplates_LevelTree : FormEngineUserControl
{
    ...
    {
        string code = @"
var checkboxes = jQuery('.level-tree-view table input[type=""checkbox""]');
checkboxes.each(function (index) {
    ...
    jQuery(label).insertAfter(checkbox);
