...
public partial class CMSModules_CMS_EmergePortalEngine_FormControls_SelectContainer : FormEngineUserControl
{
    #region "Properties"
    ...
    protected override void CreateChildControls()
    {
        ...
        bool contentAuthorized = currentUser.IsAuthorizedPerUIElement("CMS.Design", new string[] { "Design", "Design.WebPartProperties", "WebPartProperties.General" }, siteName);

        if (!IsLiveSite && deskAuthorized && contentAuthorized)
        {
            // Initialize selector
            SetDialog();
        }
