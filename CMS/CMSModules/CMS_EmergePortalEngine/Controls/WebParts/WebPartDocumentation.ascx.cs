...
public partial class CMSModules_CMS_EmergePortalEngine_Controls_WebParts_WebPartDocumentation : CMSAdminControl
{
    #region "Variables"
...
function resizeareainternal () {
    ...
    protected FormInfo GetWidgetProperties(WidgetInfo wi)
    {
        ...
        if (wpi != null)
        {
            ...
            //Removed this compared with Portal engine webpart documentation
