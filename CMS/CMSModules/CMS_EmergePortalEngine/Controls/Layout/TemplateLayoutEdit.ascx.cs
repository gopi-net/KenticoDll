...
public partial class CMSModules_CMS_EmergePortalEngine_Controls_Layout_TemplateLayoutEdit : CMSPreviewControl
{
    #region "Variables"
    ...
    private int GetPreviewState()
    {
        ...
        {
            case EditedObjectTypeEnum.Template:
                state = GetPreviewStateFromCookies(CMSPreviewControl.PAGETEMPLATELAYOUT);
                break;

            case EditedObjectTypeEnum.Layout:
                state = GetPreviewStateFromCookies(CMSPreviewControl.PAGELAYOUT);
                break;

            case EditedObjectTypeEnum.DeviceLayout:
                state = GetPreviewStateFromCookies(CMSPreviewControl.DEVICELAYUOT);
                break;
        }
