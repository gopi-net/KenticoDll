<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_CMS_EmergePortalEngine_Controls_Layout_TemplateLayoutEdit"
            ...
            <cms:UIForm runat="server" ID="EditFormLayout" ObjectType="cms.layout" DefaultFieldLayout="TwoColumns"
                ...
                <LayoutTemplate>
                    ...
                    <cms:FormCategory runat="server" ID="pnlLayout" CategoryTitleResourceString="general.layout">
                        <cms:FormField runat="server" ID="fLayoutCode" Field="LayoutCode" Layout="Inline">
