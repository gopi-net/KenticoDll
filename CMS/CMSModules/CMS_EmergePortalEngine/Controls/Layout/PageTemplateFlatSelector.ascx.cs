...
public partial class CMSModules_CMS_EmergePortalEngine_Controls_Layout_PageTemplateFlatSelector : CMSAdminControl
{
    #region "Variables"
    ...
    private bool mMultipleRoots = false;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        {
            String cat = SqlHelper.GetSafeQueryString(SelectedCategory.CategoryPath, false);
            if (!cat.EndsWith("/"))
            {
                cat += "/";
            }
        ...
        if (node != null)
        {
            ...
            //string scopeWhere = PageTemplateScopeInfoProvider.GetScopeWhereCondition(path, culture, className, level, SiteContext.CurrentSiteName, "View_CMS_PageTemplateMetafile_Joined", "PageTemplateID");
    ...
    private string ShowInDescriptionArea(string selectedValue)
    {
        ...
        if (!String.IsNullOrEmpty(selectedValue))
        {
            ...
            DataSet ds = PageTemplateInfoProvider.GetTemplates()
                ...
                .Columns("PageTemplateDisplayName", "PageTemplateDescription", "PageTemplateIsPortal", "PageTemplateIsReusable");
