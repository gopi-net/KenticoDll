<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditToolbar.ascx.cs" Inherits="CMSModules_CMS_EmergePortalEngine_Controls_OnSiteEdit_EditToolbar" %>
    ...
    function RefreshWOpener(w) {
        if (refreshPageOnClose || w.refreshPageOnClose) {
            ...
            if (window.CMSContentManager) {
                reloadUrl = jQuery.param.querystring(reloadUrl, "cmscontentchanged=" + CMSContentManager.contentModified());
