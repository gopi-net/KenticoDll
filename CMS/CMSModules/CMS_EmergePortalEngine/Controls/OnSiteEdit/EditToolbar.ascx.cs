...
public partial class CMSModules_CMS_EmergePortalEngine_Controls_OnSiteEdit_EditToolbar : CMSAbstractPortalUserControl, IPostBackEventHandler, ICallbackEventHandler
{
    #region "Constants"
    ...
    protected void ucUIToolbar_OnButtonCreated(object sender, UniMenuArgs e)
    {
        ...
        switch (e.UIElement.ElementName.ToLowerCSafe())
        {
            ...
            case "onsitecmsdesk":
                {
                    string buttonScript = String.Format("self.location.href = '{0}?nodeid={1}&returnviewmode=editlive';", ResolveUrl(AdministrationUrlHelper.GetAdministrationUrl()), NodeId);
