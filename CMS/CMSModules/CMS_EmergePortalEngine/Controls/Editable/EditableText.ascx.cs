...
public partial class CMSModules_CMS_EmergePortalEngine_Controls_Editable_EditableText : CMSUserControl
{
    #region "Variables"
                ...
                case ViewModeEnum.EditDisabled:
                    {
                        ...
                        switch (RegionType)
                        {
                            case CMSEditableRegionTypeEnum.HtmlEditor:
                                ...
                                {
                                    htmlValue.EditorAreaCSS = CssLinkHelper.GetStylesheetUrl(HTMLEditorCssStylesheet);
                                }
                                else if (SiteContext.CurrentSite != null)
                                {
                                    htmlValue.EditorAreaCSS = PortalHelper.GetHtmlEditorAreaCss(SiteContext.CurrentSiteName);
                                }
