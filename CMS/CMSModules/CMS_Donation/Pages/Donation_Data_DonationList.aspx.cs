...
public partial class CMSModules_Donation_Tools_Donation_Data_DonationList : DonationDataListPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (DataClassInfo != null)
            {
                ...
                customTableDataList.GridName = DonationConstants.PATH_DONATIONDATALIST_XML;
