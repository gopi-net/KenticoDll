...
public partial class CMSModules_Maintenance_Tools_Maintenance_Data_List : MaintenanceDataListPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            ListPage = "~/CMSModules/CMS_Maintenance/Tools/Maintenance_List.aspx";
            SelectFieldsPage = "~/CMSModules/CMS_Maintenance/Tools/Maintenance_Data_SelectFields.aspx";

            customTableDataList.EditItemPage = "~/CMSModules/CMS_Maintenance/Tools/Maintenance_Data_EditItem.aspx";
            customTableDataList.ViewItemPage = "~/CMSModules/CMS_Maintenance/Tools/Maintenance_Data_ViewItem.aspx";
