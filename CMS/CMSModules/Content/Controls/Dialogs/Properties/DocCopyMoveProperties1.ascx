<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Content_Controls_Dialogs_Properties_DocCopyMoveProperties" CodeFile="DocCopyMoveProperties.ascx.cs" %>
