...
public partial class CMSModules_Admin_Dashboard : CMSDeskPage
{
    ...
    private DataSet GetApplications()
    {
        ...
        var apps = ApplicationUIHelper.LoadApplications(where);
        return ApplicationUIHelper.FilterApplications(apps, CurrentUser, false);
    }
    ...
    {
        string path = ApplicationUrlHelper.GetApplicationUrl(ApplicationUrlHelper.GetResourceName(Convert.ToInt32(resourceID)), elementName.ToString());
