            ...
            <asp:PlaceHolder ID="plcDashboard" runat="server">
                <ul>
                    ...
                    <asp:Repeater ID="repApps" runat="server">
                        <ItemTemplate>
                            <li class="tile">
                                <a class="tile-btn <%# ApplicationCSSHelper.GetApplicationIconCssClass(EvalGuid("ElementGUID")) %>" href="<%# GetApplicationPath(Eval("ElementResourceID"), Eval("ElementName")) %>" target="_top">
