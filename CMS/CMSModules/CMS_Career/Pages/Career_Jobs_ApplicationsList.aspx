<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Career_Jobs_ApplicationsList.aspx.cs" 
    Inherits="CMSModules_CMS_Career_PagesCareer_Jobs_ApplicationsList" 
    EnableEventValidation="false"  MasterPageFile="~/CMSMasterPages/UI/SimplePage.master" Title="Job Applications - Data List"
    Theme="Default" %>
