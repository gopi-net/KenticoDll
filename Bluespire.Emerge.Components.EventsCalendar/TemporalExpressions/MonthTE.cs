...
namespace Bluespire.Emerge.Components.EventsCalendar.TemporalExpressions
{
    ...
    public class MonthTE : TemporalExpression
    {
        ...
        public MonthTE(int monthIntervals, DateTime firstDateTime, DaysOfWeek dayOfWeek)
        {
        ...
        public MonthTE(int monthIntervals, DateTime firstDateTime, DaysOfWeek dayOfWeek, MonthlyInterval monthlyInterval)
        {
            _monthIntervals = monthIntervals;
            _firstDateTime = firstDateTime.Date;
            _dayOfWeek = TEHelpers.GetDayOfWeekValue(dayOfWeek);
